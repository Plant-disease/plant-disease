...
public class ExceptionHelper {
    ...
    private boolean isDev() {
        return activeProfile == null || Objects.equals(activeProfile, "dev") || Objects.equals(activeProfile, "ser");
//                || Objects.equals(activeProfile, "prod");
    }
    ...
    public ResponseEntity<ApiResult<ErrorData>> handleException(TypeMismatchException ex) {
        return new ResponseEntity<>(
                ApiResult.errorResponse(MessageService.getMessage(ex.getMessage()), 400),
    ...
    public ResponseEntity<ApiResult<ErrorData>> handleException(DataIntegrityViolationException ex) {
        ...
        try {
            ...
            return new ResponseEntity<>(
                    ApiResult.errorResponse("Server error. Please try again", RestConstants.SERVER_ERROR),
                    HttpStatus.INTERNAL_SERVER_ERROR);
        }
        return new ResponseEntity<>(
                ApiResult.errorResponse("Server error. Please try again", RestConstants.SERVER_ERROR),
